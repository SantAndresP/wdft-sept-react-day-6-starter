...
class App extends Component {
  ...
  handleAdd = (e) => {
    ...
    axios.post(`${API_URL}/upload`, uploadForm).then((res) => {
      ...
      axios.post(`${API_URL}/create`, newTodo).then((response) => {
        this.setState(
          {
  ...
  handleDelete = (todoId) => {
    axios.delete(`${API_URL}/todos/${todoId}`).then(() => {
      ...
      <div>
        ...
        <Switch>
          ...
          <Route
            ...
            render={() => {
              return (
                <AddForm loggedInUser={loggedInUser} onAdd={this.handleAdd} />
              );
            }}
          />
